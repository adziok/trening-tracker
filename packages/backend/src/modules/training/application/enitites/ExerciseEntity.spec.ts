...
describe('ExerciseEntity', () => {
    it('should create an instance of the object using factory method', () => {
        const instance = ExerciseEntity.create({ name: 'First exercise', trainingId: UniqueEntityId.generate() });
    ...
    it('should add a series to the exercise', () => {
        const instance = ExerciseEntity.create({ name: 'First exercise', trainingId: UniqueEntityId.generate() });
    ...
    it('should remove a series from the exercise ', () => {
        const instance = ExerciseEntity.create({ name: 'First exercise', trainingId: UniqueEntityId.generate() });
